...
import PromptingRow from './PromptingRow';
...
describe('PromptingModal', () => {
    ...
    it('should render without crashes', () => {
        ...
        expect(wrapper.find(PromptingRow)).toHaveLength(2);
    });
    ...
    it('should handle remove', () => {
        ...
        expect(wrapper.find(PromptingRow)).toHaveLength(1);
    });
    ...
    it('should handle add item', () => {
        ...
        expect(wrapper.find(PromptingRow)).toHaveLength(3);
    });
