...
export const ProjectList = ({ projects: { data, loading }, currentUser, getProjects, getCurrentUser }) => {
    React.useEffect(() => {
        getProjects();
        getCurrentUser();
    ...
    const superUser =
        window.PLATFORM === 'DATABRICKS' ? currentUser.data.superuser : data.editable;
